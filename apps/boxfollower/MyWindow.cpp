...
void MyWindow::timeStepping()
{
    ...
    // add control force
    mController->computeTorques(mWorld->getSkeleton(2)->getPose(), mWorld->getSkeleton(2)->getPoseVelocity(), mWorld->getSkeleton(1)->getNode(0)->getWorldCOM());
    ...
    static_cast<BodyNodeDynamics*>(mWorld->getSkeleton(1)->getNode(0))->addExtForce(Vector3d(0.0, 0.0, 0.0), mBlockForce);
...
void MyWindow::keyboard(unsigned char key, int x, int y)
{
    ...
    case ']': // step forwardward
        ...
        break;
    case 'w': // push block around
        mBlockForce[0] = 300;
        break;
    case 's': // push block around
        mBlockForce[0] = -300;
        break;
    case 'a': // push block around
        mBlockForce[2] = 300;
        break;
    case 'd': // push block around
        mBlockForce[2] = -300;
        break;
